  ...
  <section style="table-components">
    <div class="container py-5">
      ...
      <div class="row">
                ...
                @foreach ($chats as $chat)
                    <li class="p-2 border-bottom">
                      <a href="#"   wire:click="getMessage({{ $chat->id }})" class="d-flex justify-content-between">
                        <div class="d-flex flex-row">
                          <img style="height:60px; width:60px"  src="{{ !empty($chat->worker->image)?'/images/'. $chat->worker->image : '/assets/images/profile/man.png' }}" alt="avatar"
                            class="rounded-circle d-flex align-self-center me-3 shadow-1-strong" width="60">
                          <div class="pt-1">
        ...
        @if (!empty($messages))
          <div class="col-md-6 col-lg-7 col-xl-8" id="messagesdiv">

            <ul class="list-unstyled " id="messagesul" style="height: 500px; overflow-y:auto">
                ...
                @endforeach
                <script>
                    const messagesDiv = document.getElementById('messagesul');
                      if (messagesDiv) {
